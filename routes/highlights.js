...
router.post("/", protect, async (req, res) => {
  try {
    // Auto-assign order at the end of the list
...
// PUT /api/highlights/reorder — Save new drag-and-drop order (requires login)
...
router.put("/reorder/save", protect, async (req, res) => {
  try {
    ...
    // Update each highlight's order number based on its position in the array
...
// DELETE /api/highlights/all — Clear all highlights (requires login)
